...
Run a web server, then open `index.html` in a modern browser. The map shows airports and flights, with filtering options for dates, airports, and passengers. Clicking a route displays details in the offcanvas panel.

---

## Contributions

Contributions to improve visualization, usability, or documentation are welcome.
